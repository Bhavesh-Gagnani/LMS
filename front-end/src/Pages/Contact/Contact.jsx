...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setResponseMessage(<p className="mt-4 text-green-600 text-center">{response.data.message}</p>);
  ...
  return (
    <Suspense fallback={<Loader />}>
      <div
        className="flex flex-col items-center justify-center pt-6 md:pb-20 pb-12 bg-gray-100 px-4"
        style={{ backgroundImage: `url(${assets.BG_Contact})`, backgroundSize: 'cover', backgroundPosition: 'fixed' }}
      >
        ...
        <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg w-full max-w-5xl">
          ...
          <div className="md:w-1/2 bg-gray-900 text-white p-8 flex flex-col justify-center">
            ...
            <div className="border-b-2 border-blue-700 w-24 mt-3 mb-5"></div>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              <input
                ...
                className="w-full p-3 border border-gray-600 rounded-md bg-gray-800 text-white focus:ring-2 focus:ring-blue-700"
                required
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="w-full bg-blue-700 text-white py-3 rounded-md hover:scale-95 transition duration-300"
              >
                Submit
              </button>
            </form>
